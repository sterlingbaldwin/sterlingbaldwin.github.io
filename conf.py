...
BLOG_AUTHOR = "Sterling Baldwin"  # (translatable)
BLOG_TITLE = "sterling.baldwin.io"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.sterlingbaldwin.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.sterlingbaldwin.github.io/"
BLOG_EMAIL = "sterling16@mac.com"
BLOG_DESCRIPTION = "The personal website for Sterling Baldwin"  # (translatable)
